...
1. **Download the script:**
   ...
   ```bash
   curl -o copy-claude-response https://raw.githubusercontent.com/jau123/copy-claude-response/fix/macos-compatibility/copy-claude-response
